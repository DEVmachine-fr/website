...
Ensuite, nous passerons en détail les différentes étapes pour mettre en place notre chat vocal avec **Node.js** et **Vue 3**.
...
Ensuite, nous allons installer les packages client de nos outils pour la gestion des sockets, **socket.io-client** et **simple-signal-client** :
